...
def create_models(backbone_retinanet, num_classes, weights, multi_gpu=4,
...
def parse_args(args):
    ...
    parser.add_argument('--image-min-side',   help='Rescale the image so the smallest side is min_side.', type=int, default= 500)# 800)
    parser.add_argument('--image-max-side',   help='Rescale the image if the largest side is larger than max_side.', type=int, default=830)# 1333)
